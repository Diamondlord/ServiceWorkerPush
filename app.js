firebase.initializeApp({
    messagingSenderId: '168136316916'
});
...
if (window.location.protocol === 'https:' &&
    ...
    messaging.onMessage(function(payload) {
        ...
        navigator.serviceWorker.register('/ServiceWorkerPush/messaging-sw.js');
...
function sendNotification(notification) {
    var key = 'AAAAJyW0l_Q:APA91bHLP16NQNvy-57HrmeGrTnZGIUsXA_yjRSzsW7geQNvcE695ib_ewaOJlErDwrZnaq62kvQS8kxsiLLfKqoxn5B1eUWVsDCg7yuDiX-WP1xGOglTZoYgLkBR10uYNHcp7UNeBaL';
